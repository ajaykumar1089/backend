    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('traveller', 'Traveller'), ('service_provider', 'Service Provider')], default='traveller', max_length=20)),
                ...
                ('helpdesk_number', models.CharField(blank=True, max_length=15, null=True)),
