...
from apps.bikes.models import Bike, BikeImage, BikeAvailability, BikeReview
from apps.cars.models import Car, CarImage, CarAvailability, CarReview
from apps.campervans.models import Campervan, CampervanImage, CampervanAvailability, CampervanReview
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        from apps.bikes.models import BikeCity, BikeBrand, BikeFuelType, BikeTransmission, BikeModelYear
        ...
        if all([mumbai, hero_brand, petrol_fuel, manual_trans, year_2022]):
        ...
        if all([delhi, maruti_brand, car_petrol, car_manual, hatchback, year_2022]):
        ...
        if all([campervan_city, force_brand, diesel_fuel, campervan_manual, portable_toilet, outdoor_shower, year_2022]):
            campervan1, created = Campervan.objects.get_or_create(
                campervan_name='Force Traveller Adventure',
                defaults={
        ...
        if all([pilgrim_region, pilgrim_package, pilgrim_easy]):
            tour1, created = PilgrimTour.objects.get_or_create(
                ...
                defaults={
                    ...
                    'max_participants': 25,
                    'fare_per_person': Decimal('35000.00'),
                    'service_provider': service_provider1,
                    'guide_name': 'Pandit Sharma',
                    'guide_contact': '+91-9876543221',
